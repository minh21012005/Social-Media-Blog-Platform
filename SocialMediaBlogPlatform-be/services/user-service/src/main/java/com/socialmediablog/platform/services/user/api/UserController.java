...
import com.socialmediablog.platform.services.user.application.GetCurrentUserUseCase;
...
public class UserController {
    ...
    public ApiResponse<UserProfileResponse> me(@AuthenticationPrincipal Jwt jwt) {
        ...
        return ApiResponse.success(UserProfileResponse.from(getCurrentUserUseCase.getCurrentUser(userId)));
    }
}
